			...
			<div class="conteudo">
				...
				<ul>
		            ...
		            <li><strong>Coordenadora:</strong> Prof.ª Simone Maria Viana Romano 
						<ul>
							<li><strong>Currículo: </strong><a href="http://lattes.cnpq.br/5678834007918002">Lattes</a></li>
							<li><strong>E-mail: </strong><a href="mailto:simone@fatecpg.com.br">simone@fatecpg.com.br</a></li>
						</ul>
		            </li>
				</ul>	
			</div>
